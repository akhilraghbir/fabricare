...
class Promocodes extends CI_Controller {
	...
	public function add(){
		if(($this->input->post('add'))){		
			...
			$mandatoryFields=array('promocode','promocode_type','min_cart_value','status','from_date','to_date');    
	...
	public function ajaxListing(){
		...
		$indexColumn='id';
		$selectColumns=array('*');
		$dataTableSortOrdering=array('id','Promocode','Type','Min Cart Value','From Date','To Date','status','created_on');
        ...
        if(!empty($getRecordListing)) {
            ...
            foreach($getRecordListing['data'] as $recordData) {
                ...
                $recordListing[$i][3]= $recordData->min_cart_value;
                $recordListing[$i][4]= $recordData->from_date;
                $recordListing[$i][5]= $recordData->to_date;
