<div class="col-md-12">
    ...
    <div class="main-card mb-3 card card-body">
        <h5 class="card-title"></h5>
            <?php
            $url = CONFIG_SERVER_ADMIN_ROOT . "cancellation_policy/cancellation_policy";
            ...
            <div class="form-row">
                <div class="col-md-12">
                    <div class="position-relative form-group"><label for="first name" class="">Add Cancellation Policy Content:</label>
                            <textarea name="description_p"><?= $cancellation_policy[0]['description'] ?></textarea>
                    </div>
                </div>
            </div>
            <div class="position-relative form-check">
                    <input type='hidden' name="id" value="<?php echo $cancellation_policy[0]['id'] ?>">
