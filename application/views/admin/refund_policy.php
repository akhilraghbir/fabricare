...
<div class="col-md-12">
    ...
    <div class="main-card mb-3 card card-body">
        <h5 class="card-title"></h5>
            <?php
            $url = CONFIG_SERVER_ADMIN_ROOT . "refund_policy/refund_policy";
            ...
            <div class="form-row">
                <div class="col-md-12">
                    <div class="position-relative form-group"><label for="refund_policy" class="">Add Refund Policy Content:</label>
                            <textarea name="description_p"><?= $refund_policy[0]['description'] ?></textarea>
                    </div>
                </div>
            </div>
            <div class="position-relative form-check">
                    <input type='hidden' name="id" value="<?php echo $refund_policy[0]['id'] ?>">
